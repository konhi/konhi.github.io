...
Feel free to contact me via [e-mail](mailto:hello.konhi@gmail.com), [Discord](https://discord.com) (konhi#1588) or [Twitter](https://twitter.com/konhi_). I'm **always happy** to hear from **YOU!** 💕
...
- [🚌 Poland's Public Transport API](https://github.com/konhi/poland-public-transport-api): **serverless**, community maintained **APIs** - **Cloudflare Workers**, **Zod** (type validation & safety). Previously used **Express** on **Azure**.
